...
const VIEW_SESSION_KEY = "mntn_site_view_recorded";
const STATS_POLL_MS = 4_000;
const GITHUB_URL =
  process.env.NEXT_PUBLIC_GITHUB_URL ??
  "https://github.com/acheronx0577/MNTN-Landing-Page-UI-main";
...
export default function SiteHub() {
  ...
  const backendLabel =
    stats === null ? "—" : stats.backendLive ? "Live" : "Idle";
  const backendClass =
    stats === null ? "" : stats.backendLive ? "is-ok" : "is-warn";
  const uptime =
